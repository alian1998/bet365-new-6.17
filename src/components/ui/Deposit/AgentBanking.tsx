...
const AgentBanking = ({
  ...
  return (
    <div className="w-full p-2 my-3 text-white1">
      <div>
        <p className=" font-medium mb-2 text-textColor">Payment Details</p>
        <div className="cardColor2 border-none rounded-md p-2 text-[14px]">
