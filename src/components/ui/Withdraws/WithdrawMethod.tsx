...
const WithdrawMethod = ({
  ...
  return (
    <div className="py-3 px-2">
      <h6 className="text-textColor font-medium">Withdraw Method</h6>
          ...
          depositData?.data
            ...
            .map((deposit: IPaymentMethod) => (
              <div
                ...
                className={`cardColor2 flex flex-col justify-center relative items-center gap-1 rounded-md py-1 cursor-pointer ${paymentMethodId == deposit.id
